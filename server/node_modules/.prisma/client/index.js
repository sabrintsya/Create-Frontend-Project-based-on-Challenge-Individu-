...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\sabri\\Coding\\Create Frontend Project based on Challenge (Individu)\\server\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\sabri\\Coding\\Create Frontend Project based on Challenge (Individu)\\server\\prisma\\schema.prisma"
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
    "schemaEnvPath": "../../../.env"
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id          String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name        String?\n  email       String   @unique\n  image       String?\n  register    Json[]\n  favCourseiD String[] @db.ObjectId\n  ownedCourse Course[] @relation(\"owner\")\n}\n\nmodel Course {\n  id          String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  title       String\n  description String\n  price       Int\n  address     String\n  city        String\n  country     String\n  image       String\n  facilities  Json\n  userEmail   String\n  owner       User     @relation(\"owner\", fields: [userEmail], references: [email])\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "460307bc42f536fad728bbfcfe9c45c9f44cbcfe577d9bf85fc9762505118223",
  "copyEngine": true
}
